...
jd_small_dfm_train<-MLTASS_dfm(jd_small_train$FullDescription,ngrams=1)

jd_small_dfm_test<-MLTASS_dfm(jd_small_test$FullDescription,
                            ngrams=1,min.prop = 0) %>%
...
jd_small_dfm_test<-MLTASS_dfm(jd_small_test$FullDescription,ngrams=1,min.prop=0) %>%
  dfm_match(colnames(jd_small_dfm_train))
...
stmEffects<-estimateEffect(1:topicNum~SalaryNormalized,
                           jd_topicMod20,
                           meta= jd_small_train %>%
...
jd_cats_dfm_train<-MLTASS_dfm(jd_cats_train$FullDescription,ngrams=1)

jd_cats_dfm_test<-MLTASS_dfm(jd_cats_test$FullDescription,
                           ngrams=1,min.prop=0) %>%
