...
ecMain_train_dfm_q<-MLTASS_dfm(ecMain_train$questiontext)
...
ecMain_train_dfm_a<-MLTASS_dfm(ecMain_train$answertext)
...
ecMain_test_dfm_q<-MLTASS_dfm(ecMain_test$questiontext,
                              min.prop=0) %>%
...
ecMain_test_dfm_a<-MLTASS_dfm(ecMain_test$answertext,
                              min.prop=0) %>%
...
Qngram<-MLTASS_dfm(QApairs$question)
Angram<-MLTASS_dfm(QApairs$answer)
